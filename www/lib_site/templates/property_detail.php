...
?>
            ...
            <?	if ($listing['market_type_id'] or $listing['deal_type_id'] or $listing['mortgage_available']) { ?>
                    ...
                    <?	}
                        if ($listing['mortgage_available']) { ?>
                        	<li>
                                Возможна ипотека
                                <a href="<?=$_SERVER['REQUEST_URI']?>#calc" class="detail-price-calc" title="Ипотечный калькулятор"></a>
                            </li>
                    <?	} ?>
                    </ul>
            <?	} ?>
    ...
    <?  } 
        ...
        <div id="calc" class="detail-calc-iframe detail-folded">
            ...
            <div class="detail-folded-body">
                ...
                <div style="margin-top:5px; font-size: 0.9em; color:#999">Ипотечный калькулятор предоставлен сайтом <a href="https://calcus.ru" target="_blank">calcus.ru</a></div>
                <script>
    ...
    <div class="detail-order">
        ...
        <div class="detail-order-phone">По телефону <span class="detail-order-phone-number"><a href="tel:<?=$tel?>"><?=$tel?></a></span></div>
   	    <div class="detail-order-message">Или оставьте свои контактные данные, и мы вам перезвоним</div>
        <div id="contact_form">
